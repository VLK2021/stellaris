const en = {
    ...
    exoplanets: {
        ...
        atmospheres: {
            backToExoplanets: "Back to Exoplanets",
            backToAtmospheres: "Back to Atmospheres",
            eyebrow: "Exoplanet Atmospheres",
            title: "Atmospheric Candidates",
            description:
                "Analytical section about potential exoplanet atmospheres based on temperature, radius, mass, density, insolation and host-star parameters.",
            search: "Search",
            searchPlaceholder: "Search planet or host star...",
            sortBy: "Sort By",
            order: "Order",
            asc: "Ascending",
            desc: "Descending",
            ...
            stellarRadius: "Stellar Radius",
            stellarMass: "Stellar Mass",
            atmosphereScore: "Atmosphere Score",
            atmosphereClass: "Atmosphere Class",
            atmosphereProfile: "Atmosphere Profile",
            candidateType: "Candidate Type",
            planetParameters: "Planet Parameters",
            stellarContext: "Stellar Context",
            temperateClass: "Temperate Zone",
            warmClass: "Warm Zone",
            hotClass: "Hot Zone",
            coldClass: "Cold Zone",
            unknownClass: "Unknown Class",
            rockyCandidate: "Rocky Candidate",
            subNeptune: "Sub-Neptune",
            gasGiant: "Gas Giant",
            lowDensity: "Low Density",
            unknownCandidate: "Unknown Type",
            details: "Details",
            detailsDescription:
                "This is not a direct weather observation, but an analytical estimate of an exoplanet atmosphere potential based on physical parameters from NASA Exoplanet Archive.",
            openPlanetCatalog: "Open in Planet Catalog",
            unknown: "Unknown",
    ...
    mars: {
        ...
        photosBack: "Back to Mars",
        photosEyebrow: "Mars Photo Archive",
        photosTitle: "Mars photo archive",
        photosDescription:
            "Real NASA Mars rover camera images with filtering by rover, camera, Earth date, sol and page.",
        filters: "Filters",
        selectRover: "Rover",
        selectCamera: "Camera",
        ...
        sortSolDesc: "Sol descending",
        sortSolAsc: "Sol ascending",
        ...
        nextPage: "Next",
        emptyPhotos: "No photos found for these parameters.",
    ...
    missions: {
        ...
        missionDetails: {
            ...
            crew: "Crew",
            crewMissing: "Crew data was not found.",
            crewMember: "Crew member",
            openWikipedia: "Open in Wikipedia",
            vehicles: "Vehicles & operators",
            vehiclesMissing: "Vehicle data was not found.",
            operator: "Operator",
