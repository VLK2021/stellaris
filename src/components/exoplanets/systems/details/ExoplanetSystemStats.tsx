...
export const ExoplanetSystemStats = ({data, t}: Props) => {
    ...
    return (
        <section className="grid gap-5 xl:grid-cols-[1fr_1fr]">
            <Panel
                title={t.stellarPhysics}
                eyebrow={t.hostStar}
                description={system.hostname ?? t.unknown}
            >
...
const Panel = ({
    ...
    <article className="relative overflow-hidden rounded-[2.2rem] border border-[var(--color-border)] bg-[var(--color-card)] p-5 shadow-[var(--shadow-card)]">
...
const Metric = ({
    ...
    <div className="group rounded-[1.2rem] border border-[var(--color-border)] bg-[var(--color-glass)] p-4 transition hover:border-[var(--color-accent)]">
