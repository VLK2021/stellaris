...
export const LiveMediaDock = ({locale, epic, marsMedia, donki}: Props) => {
    ...
    return (
        ...
        >
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_18%_40%,rgba(34,211,238,0.1),transparent_28%),radial-gradient(circle_at_50%_58%,rgba(168,85,247,0.1),transparent_26%),radial-gradient(circle_at_84%_38%,rgba(251,146,60,0.1),transparent_28%)]" />
            ...
            >
                <path d="M205 250 C360 150 500 165 610 275 C760 430 920 360 1010 235" stroke="rgba(34,211,238,.2)" strokeWidth="2" fill="none" />
                <path d="M205 250 C390 395 560 430 720 360 C850 300 940 260 1010 235" stroke="rgba(251,146,60,.16)" strokeWidth="2" fill="none" />
            ...
            <div className="absolute left-1/2 top-[45%] z-10 h-[150px] w-[150px] -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/8 bg-white/[0.025] backdrop-blur-xl">
                <motion.div
                ...
                <div className="flex h-full flex-col items-center justify-center text-center">
                    ...
                    <div className="mt-3 space-y-1 text-[9px] uppercase tracking-[0.13em] text-slate-500">
                        <p>EPIC: {epic ? "online" : "sync"}</p>
                        <p>MARS: {marsMedia ? "online" : "sync"}</p>
                        <p>DONKI: {donki ? "online" : "sync"}</p>
                    </div>
                </div>
            </div>
