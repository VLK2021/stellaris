...
export const DeepSpaceSignalNode = ({signal, locale, index}: Props) => {
    ...
    return (
        <Link href={signal.href} className="absolute z-30" style={{left: signal.x, top: signal.y}}>
            <motion.article
            ...
            >
                <motion.div
                    ...
                    animate={{boxShadow: ["0 0 14px rgba(34,211,238,.16)", "0 0 30px rgba(34,211,238,.42)", "0 0 14px rgba(34,211,238,.16)"]}}
                ...
                <div className="max-w-[126px]">
                    ...
                    <p className="mt-0.5 text-[9px] leading-4 text-slate-300">{copy.region}</p>
                    <p className="text-[9px] leading-4 text-slate-400">{copy.distance}</p>
                    <p className="text-[9px] leading-4 text-emerald-300">{copy.delay}</p>
                </div>
            </motion.article>
        </Link>
    );
